...
PARALLELIZE_DOCSTRING = r"""
    ...
    ```python
    # Here is an example of a device map on a machine with 4 GPUs using mt5-large, which has a total of 24 attention modules:
...
# Copied from transformers.models.t5.modeling_t5.load_tf_weights_in_t5
...
# Copied from transformers.models.t5.modeling_t5.T5PreTrainedModel with T5->MT5
...
MT5_START_DOCSTRING = r"""
    ...
    The mT5 model was presented in mT5: [A massively multilingual pre-trained text-to-text transformer](https://arxiv.org/abs/2010.11934)
    by Linting Xue, Noah Constant, Adam Roberts, Mihir Kale, Rami Al-Rfou, Aditya Siddhant, Aditya Barua, Colin Raffel.
    It is a multilingual variant of T5 that was pre-trained on a new Common Crawl-based dataset covering 101 languages.
...
# Copied from transformers.models.t5.modeling_t5.T5Model with T5->MT5
@add_start_docstrings(
...
# Copied from transformers.models.t5.modeling_t5.T5ForConditionalGeneration with T5->MT5
...
# Copied from transformers.models.t5.modeling_t5.T5EncoderModel with T5->MT5
@add_start_docstrings(
